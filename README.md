...
4. Lastly, if you need to perform additional tasks related to the contract, you can use the `make all` command. This command executes a predefined set of actions specified in the project's Makefile.
